...
(function () {
  var GROUPS = [
    ...
    },
    {
      ...
      tools: [
        { slug: 'appointment-scheduler', icon: '📅', name: 'Appointment Scheduler', blurb: 'Book appointments and catch time clashes before they happen.' },
        { slug: 'staff-attendance', icon: '🗓️', name: 'Staff Attendance', blurb: 'Mark attendance on a month grid; %s work themselves out.' },
        { slug: 'inventory-tracker', icon: '📦', name: 'Inventory Tracker', blurb: 'Know your stock and get warned before it runs out.' },
        { slug: 'vendor-tracker', icon: '🚚', name: 'Vendor Tracker', blurb: 'Every supplier and exactly what you owe them.' },
        { slug: 'document-storage', icon: '🗂️', name: 'Document Storage', blurb: 'Keep every paper and find it in one search.' },
        { slug: 'renewal-reminder', icon: '🔔', name: 'Renewal Reminder', blurb: 'See every renewal and payment before it goes overdue.' }
      ]
    },
    {
    ...
    },
    {
      ...
      tools: [
        { slug: 'blog-post-writer', icon: '✍️', name: 'Blog Post Writer', ai: true, blurb: 'Keep your blog active for SEO without writing every post.' },
        { slug: 'about-us-writer', icon: '📖', name: 'About Us Writer', ai: true, blurb: 'Turn your business story into copy that actually reads well.' }
      ]
    },
    {
      label: 'Utilities',
